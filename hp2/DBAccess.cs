...
namespace hp2
{
    class DBAccess
    {
        ...
        //ahad = @"Data Source=DESKTOP-E1OVDS8\SQLEXPRESS;Initial Catalog=Project;Integrated Security=True"

        //ashik="Data Source=(local);Initial Catalog=Project;Integrated Security=True"
